...
function eegOnscreenInstruct(win,vars)
    ...
    Screen('DrawText', win, 'Answer', (optionCoords(1,1)+optionCoords(3,1))/2, (optionCoords(2,1)+optionCoords(4,1))/2, [255,255,255]);
    Screen('DrawText', win, 'Flip Tile', (optionCoords(1,2)+optionCoords(3,2))/2, (optionCoords(2,2)+optionCoords(4,2))/2, [255,255,255]);
end