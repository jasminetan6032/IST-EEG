...
function [trials] = getTrials(vars)
    ...
    'finalAns',cell(1,b),'finalColour',cell(1,b),'numOfCjs',cell(1,b),'firstCjGiven',cell(1,b),...
    ...
    cell(1,b),'trueColourGrid',cell(1,b),'finalGridState',cell(1,b),'trialBreakdown',struct('flipNumber',cell(1,tiles),'colourRevealed',...
            cell(1,tiles),'majorityColour',cell(1,tiles),'majorityAmount',cell(1,tiles),...
            'timestamp',cell(1,tiles),'timeSinceLastFlip',cell(1,tiles),'currentGrid',...
            cell(1,tiles),'tileClicked',cell(1,tiles)));
