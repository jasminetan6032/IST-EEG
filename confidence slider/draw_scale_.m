...
Screen('FillRect', Sc.window, [.3 .3 .3], cfg.bar.barrect); % draw bar for response:
Screen('FillRect', Sc.window, Sc.bkgCol, cfg.bar.gaprect); % draw gap on top of response bar
