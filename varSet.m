...
%     vars.expBlocks = [1,1,0];
    ...
    %Set variable difficulty levels. Larger number is always in Column 1
    %Currently it's only set for a 5-by-5 grid with 5 difficulty levels.
    vars.difficultyLevels = zeros(5,2);
